...
export const sampleIoMTFleet: IoMTDevice[] = [
  ...
  {
    id: "IOMT-ROBOT-06",
    name: "Intuitive DaVinci Xi Surgical Robot Console #01",
    type: "Surgical Robot Hub",
    department: "Robotic Surgery OT",
    ipAddress: "10.24.150.08",
    macAddress: "00:50:56:A1:B2:C3",
    firmwareVersion: "v6.2.0-FIPS",
    hsmStatus: "SECURE_LOCKED",
    firmwareHash: "8b74c20193847561928374659102938475610293847561029384756102938475",
    isTampered: false,
    status: "NORMAL",
    telemetry: {
      battery: 100,
  ...
  {
    id: "IOMT-PACEMAKER-07",
    name: "Medtronic CareLink Cardiac Pacemaker RF Gateway #03",
    type: "Cardiac Pacemaker Gateway",
    department: "Cardiology & Cath Lab",
    ipAddress: "10.24.160.22",
    macAddress: "3C:D9:2B:44:88:1A",
    firmwareVersion: "v3.8.4-SEC",
    hsmStatus: "SECURE_LOCKED",
    firmwareHash: "1928374650192837465910293847561029384756102938475610293847561029",
    isTampered: false,
    status: "NORMAL",
    telemetry: {
      battery: 95,
  ...
  {
    id: "IOMT-NICU-08",
    name: "Draeger Isolette Infant Incubator #02",
    type: "Neonatal Incubator",
    department: "Neonatal ICU (NICU)",
    ipAddress: "10.24.170.14",
    macAddress: "00:1E:C9:3F:77:99",
    firmwareVersion: "v4.1.1-PROD",
    hsmStatus: "SECURE_LOCKED",
    firmwareHash: "4756102938475610293847561029384756102938475610293847561029384756",
    isTampered: false,
    status: "NORMAL",
    telemetry: {
      battery: 100,
  ...
  {
    id: "IOMT-CHEMO-09",
    name: "RIVA Automated Chemotherapy Compounding Robot",
    type: "Medication Dispenser",
    department: "Oncology",
    ipAddress: "10.24.180.35",
    macAddress: "78:2B:CB:11:44:EE",
    firmwareVersion: "v5.0.3-CRYPTO",
    hsmStatus: "SECURE_LOCKED",
    firmwareHash: "9283746501928374659102938475610293847561029384756102938475610293",
    isTampered: false,
    status: "NORMAL",
    telemetry: {
      battery: 100,
